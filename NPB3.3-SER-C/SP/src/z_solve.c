...
void z_solve()
{
  ...
  /*for (j = 1; j <= ny2; j++) {*/
    ...
    /*for (i = 1; i <= nx2; i++) {*/
      FOR_START(k, cit3, 0, nz2+2, 1, cit_step_add, RND) {
      /*for (k = 0; k <= nz2+1; k++) {*/
      ...
      FOR_START(k, cit3, 1, nz2+1, 1, cit_step_add, RND) {
      /*for (k = 1; k <= nz2; k++) {*/
        lhs[k][i][0] =  0.0;
    ...
    FOR_START(k, cit2, 3, nz2-2+1, 1, cit_step_add, RND) {
    /*for (k = 3; k <= nz2-2; k++) {*/
    ...
    //---------------------------------------------------------------------
    FOR_START(k, cit2, 1, nz2+1, 1, cit_step_add, RND) {
    /*for (k = 1; k <= nz2; k++) {*/
      FOR_START(i, cit3, 1, nx2+1, 1, cit_step_add, RND) {
      /*for (i = 1; i <= nx2; i++) {*/
    ...
    // FORWARD ELIMINATION
    //---------------------------------------------------------------------
    FOR_START(k, cit2, 0, grid_points[2]-3+1, 1, cit_step_add, FWD) {
    ...
    //---------------------------------------------------------------------
    FOR_START(k, cit2, grid_points[2]-3, -1, -1, cit_step_add, FWD) {
