...
void ssor(int niter)
{
  ...
  //---------------------------------------------------------------------
#ifdef USE_CITERATOR
  FOR_START(j, cit1, 0, ISIZ2, 1, cit_step_add, RND) {
  /*for (j = 0; j < ISIZ2; j++) {*/
    FOR_START(i, cit2, 0, ISIZ1, 1, cit_step_add, RND) {
    /*for (i = 0; i < ISIZ1; i++) {*/
      FOR_START(n, cit3, 0, 5, 1, cit_step_add, RND) {
      /*for (n = 0; n < 5; n++) {*/
  ...
  */
  ...
  //---------------------------------------------------------------------
#ifdef USE_CITERATOR
  FOR_START(istep, cit1, 1, niter+1, 1, cit_step_add, FWD) {
  /*for (istep = 1; istep <= niter; istep++) {*/
    ...
    FOR_START(k, cit2, 1, nz-1, 1, cit_step_add, RND) {
    /*for (k = 1; k < nz - 1; k++) {*/
      FOR_START(j, cit3, jst, jend, 1, cit_step_add, RND) {
      /*for (j = jst; j < jend; j++) {*/
        FOR_START(i, cit4, ist, iend, 1, cit_step_add, RND) {
        /*for (i = ist; i < iend; i++) {*/
          FOR_START(m, cit5, 0, 5, 1, cit_step_add, RND) {
          /*for (m = 0; m < 5; m++) {*/
    ...
    FOR_START(k, cit2, 1, nz-1, 1, cit_step_add, FWD) {
    /*for (k = 1; k < nz -1; k++) {*/
      //---------------------------------------------------------------------
    ...
    FOR_START(k, cit2, nz-2, 0, -1, cit_step_add, FWD) {
    /*for (k = nz - 2; k > 0; k--) {*/
      //---------------------------------------------------------------------
